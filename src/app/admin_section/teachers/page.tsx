    ...
    { field: "contact", headerName: "Contact", width: 140, editable: true },
    {
      ...
      getActions: ({ id }) => {
        ...
        return isEditing
          ...
          : [
              <GridActionsCellItem icon={<VisibilityIcon />} label="View" onClick={() => handleViewClick(id)} />,
            ...
            <Grid container spacing={1}>
              ...
              <Grid item xs={6}>
                <TextField
                  ...
                  onChange={(e) => setNewTeacher({ ...newTeacher, appointmentLetter: e.target.value })}
                  InputLabelProps={{ shrink: true }}
                />
              </Grid>
              ...
              <Grid item xs={6}>
                <TextField
                  ...
                  onChange={(e) => setNewTeacher({ ...newTeacher, firstRankDate: e.target.value })}
                  InputLabelProps={{ shrink: true }}
                />
              </Grid>
